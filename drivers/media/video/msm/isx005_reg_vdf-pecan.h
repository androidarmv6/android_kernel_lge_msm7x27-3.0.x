...
tuning_reg_settings_array[] = {	//091214
	...
	{0x46B6,0x2d  , BYTE_LEN},
	{0x46B7,0x2b  , BYTE_LEN},
	...
	{0x4708,0x3a  , BYTE_LEN},
	{0x4709,0x37  , BYTE_LEN},
	{0x470A,0x35  , BYTE_LEN},
	{0x470B,0x33  , BYTE_LEN},
	{0x470C,0x32  , BYTE_LEN},
	{0x470D,0x31  , BYTE_LEN},
	...
	{0x473D,0x16  , BYTE_LEN},
	{0x473E,0x19  ,BYTE_LEN},
	{0x473F,0x16  ,BYTE_LEN},
	{0x4400,0x00  ,BYTE_LEN},
	{0x4C0A,0xE200, WORD_LEN},
	{0x4C0C,0xDA00, WORD_LEN},
	...
	{0x444A,0x0090, WORD_LEN},
	{0x444C,0x008C, WORD_LEN},
	...
	{0x401C,0x2E07, WORD_LEN},
	{0x401E,0x8C04, WORD_LEN},
	{0x4020,0x8801, WORD_LEN},
	...
	{0x50A2,0x5A  , BYTE_LEN},
	{0x50A3,0x48  , BYTE_LEN},
	{0x50A4,0x5A  , BYTE_LEN},
	{0x50A5,0x48  , BYTE_LEN},
	{0x50A6,0x64  , BYTE_LEN},
	{0x50A7,0x48  , BYTE_LEN},
	{0x50A8,0x64  , BYTE_LEN},
	{0x50A9,0x56  , BYTE_LEN},
	{0x50C2,0x17  ,BYTE_LEN},
	{0x50C3,0x15  ,BYTE_LEN},
	{0x01B1,0x80  ,BYTE_LEN},
	{0x4E0B,0x01  ,BYTE_LEN},
	{0x4E0C,0x0003, WORD_LEN},
	{0x4E0E,0x0005, WORD_LEN},
	{0x4E10,0xC000, WORD_LEN},
	...
	{0x4E44,0x160d, WORD_LEN},
	{0x4E46,0xb20c, WORD_LEN},
