...
static struct isx005_register_address_value_pair
	init_tmp_reg_settings_array[20];
static struct isx005_register_address_value_pair
	tuning_tmp_reg_settings_array[4000];
static struct isx005_register_address_value_pair
	prev_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	snap_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	effect_off_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	effect_mono_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	effect_negative_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	effect_solarize_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	effect_sepia_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	effect_aqua_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	wb_auto_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	wb_incandescent_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	wb_fluorescent_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	wb_daylight_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	wb_cloudy_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	iso_auto_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	iso_100_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	iso_200_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	iso_400_tmp_reg_settings_array[50];
static struct isx005_register_address_value_pair
	brightness_tmp_reg_settings_array[50];
// 2010-11-24 add framerate mode
static struct isx005_register_address_value_pair
 auto_tmp_framerate_mode_reg_settings_array[50];
static struct isx005_register_address_value_pair
	fixed_tmp_framerate_mode_reg_settings_array[50];


// 2011-03-21 for Samsung Sensor
static struct isx005_register_address_value_pair const
init_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
tuning_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
auto_framerate_mode_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
fixed_framerate_mode_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
preview_mode_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
snapshot_mode_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
effect_mode_off_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
effect_mode_mono_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
effect_mode_negative_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
effect_mode_solarize_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
effect_mode_sepia_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
effect_mode_aqua_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
wb_mode_auto_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
wb_mode_incandescent_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
wb_mode_fluorescent_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
wb_mode_daylight_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
wb_mode_cloudy_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
iso_mode_auto_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
iso_mode_100_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
iso_mode_200_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
iso_mode_400_reg_settings_array2[1];
static struct isx005_register_address_value_pair const
brightness_reg_settings_array2[1];
...
static void parsing_register(char* buf, int buf_size)
{
 ...
 //pll
 isx005_regs.init_reg_settings = init_tmp_reg_settings_array;
 isx005_regs.init_reg_settings_size = init_cnt;

 //init
 isx005_regs.tuning_reg_settings = tuning_tmp_reg_settings_array;
 isx005_regs.tuning_reg_settings_size = tuning_cnt;

 // preview
 isx005_regs.prev_reg_settings = prev_tmp_reg_settings_array;
 isx005_regs.prev_reg_settings_size = prev_cnt;

 // capture
 isx005_regs.snap_reg_settings = snap_tmp_reg_settings_array;
 isx005_regs.snap_reg_settings_size = snap_cnt;

 // effect : off
 isx005_regs.effect_off_reg_settings = effect_off_tmp_reg_settings_array;
 isx005_regs.effect_off_reg_settings_size = effect_off_cnt;

 // effect : mono
 isx005_regs.effect_mono_reg_settings = effect_mono_tmp_reg_settings_array;
 isx005_regs.effect_mono_reg_settings_size = effect_mono_cnt;

 // effect : negative
 isx005_regs.effect_negative_reg_settings = effect_negative_tmp_reg_settings_array;
 isx005_regs.effect_negative_reg_settings_size = effect_negative_cnt;

 // effect : solarize
 isx005_regs.effect_solarize_reg_settings = effect_solarize_tmp_reg_settings_array;
 isx005_regs.effect_solarize_reg_settings_size = effect_solarize_cnt;

 // effect : sepia
 isx005_regs.effect_sepia_reg_settings = effect_sepia_tmp_reg_settings_array;
 isx005_regs.effect_sepia_reg_settings_size = effect_sepia_cnt;

 // effect : aqua
 isx005_regs.effect_aqua_reg_settings = effect_aqua_tmp_reg_settings_array;
 isx005_regs.effect_aqua_reg_settings_size = effect_aqua_cnt;

 // WB : auto
 isx005_regs.wb_auto_reg_settings = wb_auto_tmp_reg_settings_array;
 isx005_regs.wb_auto_reg_settings_size = wb_auto_cnt;

 // WB : incandescent
 isx005_regs.wb_incandescent_reg_settings = wb_incandescent_tmp_reg_settings_array;
 isx005_regs.wb_incandescent_reg_settings_size = wb_incandescent_cnt;

 // WB : fluorescent
 isx005_regs.wb_fluorescent_reg_settings = wb_fluorescent_tmp_reg_settings_array;
 isx005_regs.wb_fluorescent_reg_settings_size = wb_fluorescent_cnt;

 // WB : daylight
 isx005_regs.wb_daylight_reg_settings = wb_daylight_tmp_reg_settings_array;
 isx005_regs.wb_daylight_reg_settings_size = wb_daylight_cnt;

 // WB : cloudy
 isx005_regs.wb_cloudy_reg_settings = wb_cloudy_tmp_reg_settings_array;
 isx005_regs.wb_cloudy_reg_settings_size = wb_cloudy_cnt;

 // ISO : auto
 isx005_regs.iso_auto_reg_settings = iso_auto_tmp_reg_settings_array;
 isx005_regs.iso_auto_reg_settings_size = iso_auto_cnt;

 // ISO : 100
 isx005_regs.iso_100_reg_settings = iso_100_tmp_reg_settings_array;
 isx005_regs.iso_100_reg_settings_size = iso_100_cnt;

 // ISO : 200
 isx005_regs.iso_200_reg_settings = iso_200_tmp_reg_settings_array;
 isx005_regs.iso_200_reg_settings_size = iso_200_cnt;

 // ISO : 400
 isx005_regs.iso_400_reg_settings = iso_400_tmp_reg_settings_array;
 isx005_regs.iso_400_reg_settings_size = iso_400_cnt;

 // Brightness
 isx005_regs.brightness_reg_settings = brightness_tmp_reg_settings_array;
 isx005_regs.brightness_reg_settings_size = brightness_cnt;
 
 // auto framerate mode
	isx005_regs.auto_framerate_reg_settings = auto_tmp_framerate_mode_reg_settings_array;
	isx005_regs.auto_framerate_reg_settings_size = auto_fps_cnt;

 // fixed framerate mode
	isx005_regs.fixed_framerate_reg_settings = fixed_tmp_framerate_mode_reg_settings_array;
	isx005_regs.fixed_framerate_reg_settings_size = fixed_fps_cnt; 
}

static void isx005_read_register_from_file()
{
	int fd;
	mm_segment_t oldfs;
	char* buf;
	...
	fd = sys_open("/sdcard/register", O_RDONLY, 0644);
 ...
 printk(KERN_ERR "[tun] memory allocation");
