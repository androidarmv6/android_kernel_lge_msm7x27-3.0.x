...
MACHINE_START(MSM7X27_GELATO, "GELATO Global board (LGE P690)")
#elif defined(CONFIG_MACH_MSM7X27_MUSCAT)
MACHINE_START(MSM7X27_MUSCAT, "MUSCAT board (LGE C660)")
#elif defined(CONFIG_MACH_MSM7X27_PECAN)
MACHINE_START(MSM7X27_PECAN, "PECAN board (LGE 350)")
#elif defined(CONFIG_MACH_MSM7X27_THUNDERG)
MACHINE_START(MSM7X27_THUNDERG, "THUNDER Global board (LGE P500)")
#elif defined(CONFIG_MACH_MSM7X27_UNIVA)
MACHINE_START(MSM7X27_UNIVA, "UNIVA Global board (LGE LGE E510)")
#else
