...
// usb functions aren't defined from here anymore

// nor are usb products

// nor is anything to do with usb!

// especially not the crap they included for auto-run off cd's!!!
