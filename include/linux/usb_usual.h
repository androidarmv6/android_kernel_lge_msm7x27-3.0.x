...
/* For Thunder 2.6.32 Kernel Build (originally, below 2 prototypes is located above #ifdef CONFIG_USB_LIBUSUAL) */
/* Rashed Abdel-Tawab: We will do the same with 3.0.31 */
